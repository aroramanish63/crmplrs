...
<div class="container_12">
    <?php
    $AdduserRolebtn = '<fieldset>
                <a title="Add User Role" href="' . SITE_URL . '?page=adduserRole"><input class="submit-green" style="float:right" type="button" value="Add" /></a>
            </fieldset>';
    echo ($_SESSION['role']['adduserRole']) ? $AdduserRolebtn : '';
    ?>
    ...
    <div class="module">
        ...
        <div class="module-table-body">
            <table id="myTable" class="tablesorter">
                ...
                <tbody>
                    <?php
                    $listingarr = $userFunc->getUserRoles();
                    if (is_array($listingarr)) {
                        $i = 1;
                        foreach ($listingarr as $list) {
                            echo '<tr>';
                            echo '<td>' . $i . '</td>';
                            echo '<td>' . $list['role_name'] . '</td>';
                            echo '<td>' . $list['page_name'] . '</td>';
                            echo '<td>' . $list['role_description'] . '</td>';
                            echo '<td><a href="' . SITE_URL . '?page=edituserRole&idu=' . $list['id'] . '"><img src="' . IMAGE_URL . 'bin.gif" width="16" title="Edit" height="16" alt="Edit" /></a></td>';
