...
<div class="container_12">
    ...
    if ((isset($_SERVER['REQUEST_METHOD']) && ($_SERVER['REQUEST_METHOD'] == 'POST') && isset($_POST['btnsearch'])) || (!$complaintFunc->isCallCentreStaff($_SESSION['uid']))) {
        ?>
        <div class="module">
